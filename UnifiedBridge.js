...
export default [
  ...
  { inputs: [], name: 'FailedTokenWrappedDeployment', type: 'error' },
  { inputs: [], name: 'GasTokenNetworkMustBeZeroOnEther', type: 'error' },
  ...
  { inputs: [], name: 'NativeTokenIsEther', type: 'error' },
  { inputs: [], name: 'NoValueInMessagesOnGasTokenNetworks', type: 'error' },
  ...
  { inputs: [], name: 'OnlyRollupManager', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
